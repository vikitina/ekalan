...
class Collection extends TableGateway
{
    protected $tableName  = 't_collection';
    protected $idCol = 'id';
   ...
   public function getCollection($id)
    { 
        ...
        $query = "SELECT * from `t_collection` where id ='".$id."'";
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  public function updateCollection($data=null)
    { 
      $id = $data['id'];
  ...
  public function delCollection($id)
    {
         $query = sprintf("DELETE FROM t_collection WHERE id='%s'",$id);
